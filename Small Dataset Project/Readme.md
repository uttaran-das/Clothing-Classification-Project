...
I have used a different base model from the one used in the original project. Also, I have used 2D Convolutional Layer as the next layer of the base model instead of Dense Layer used in the above proect which gave a better accuracy (approximately 86.21%) for the validation data in smaller model after Data Augmentation.
